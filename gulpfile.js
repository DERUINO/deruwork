...
gulp.task('sass', function() { // Создаем таск Sass
	return gulp.src('src/css/scss/*.scss') // Берем источник
...
gulp.task('img', function() {
	return gulp.src('src/css/images/**/*') // Берем все изображения из app
...
gulp.task('prebuild', async function() {
	...
	var build = gulp.src('src/**/*') // Переносим шрифты в продакшен
	.pipe(gulp.dest('dist'))
...
gulp.task('watch', function() {
	gulp.watch('src/css/scss/*.scss', gulp.parallel('sass')); // Наблюдение за sass файлами
